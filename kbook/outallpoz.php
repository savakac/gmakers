...
$vysledek=mysql_query("select pozicane.id, knihy.id as idk, knihy.nazov, citatel.id as idc, citatel.priezvisko, citatel.meno, pozicane.datumPozicania from knihy join pozicane on knihy.id = pozicane.kniha join citatel on pozicane.citatel = citatel.id where datumVratenia is null");
